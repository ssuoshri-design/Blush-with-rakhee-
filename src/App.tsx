...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col justify-between selection:bg-brand-blush">
      ...
      {/* Deep Redesigned Luxury Footer section - Clean, elegant, non-SaaS, no phone numbers */}
      <footer className="bg-[#12100F] text-[#ECE7E3] border-t border-[#B76E79]/15 pt-16 pb-12 px-6 lg:px-12 text-left transition-colors relative overflow-hidden font-sans">
        ...
        <div className="absolute bottom-0 right-1/4 w-96 h-96 rounded-full bg-amber-500/[0.02] blur-3xl pointer-events-none" />

        <div className="max-w-7xl mx-auto space-y-12 relative z-10">
          
          {/* Main Footer Column Grid - 3 clean, simple, un-congested columns */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 items-start">
            
            {/* COLUMN 1: Brand & Contact Info */}
            <div className="lg:col-span-5 space-y-6">
              <div className="space-y-3">
                <h4 className="font-serif text-xl tracking-[0.15em] text-[#E8C8C8] font-medium">
                  BLUSH <span className="font-serif italic text-[#ECE7E3] tracking-normal lowercase">with</span> RAKHEE
                </h4>
                <p className="text-xs text-stone-400 leading-relaxed max-w-sm font-sans">
                  Empowering beauty enthusiasts and aspiring makeup artists through professional makeup artistry programs and signature transformation masterclasses.
                </p>
              </div>
              ...
              <div className="flex items-center gap-3 pt-1">
                <a href="https://www.instagram.com/blushwithrakhee?igsh=MXBjMGFxZjN1cWR0OQ==" target="_blank" rel="noreferrer" title="Instagram" 
                   className="w-10 h-10 rounded-full bg-white/5 border border-white/10 hover:border-[#B76E79] hover:bg-[#B76E79] hover:-translate-y-0.5 transition-all duration-300 flex items-center justify-center text-[#ECE7E3]">
                  <Instagram size={15} />
                </a>
              ...
              {/* Academy Coordinates - Clean list with no phone, SLA, or technical headers */}
              <div className="space-y-3 pt-4 border-t border-white/5 text-xs text-stone-300 font-sans">
                <h5 className="font-serif italic text-xs tracking-wide text-[#E8C8C8]">Academy Coordinator Desk</h5>
                <ul className="space-y-3">
                  <li className="flex items-start gap-2.5">
                    <Mail size={14} className="text-[#B76E79] shrink-0 mt-0.5" />
                    <div>
                      <p className="text-[10px] text-stone-500 leading-none mb-1 font-sans">Admissions &amp; Bookings</p>
                      <a href="mailto:rakhee.chakraborty1985@gmail.com" className="hover:text-white transition-colors font-sans">
                        rakhee.chakraborty1985@gmail.com
                      </a>
                    </div>
                  </li>
                  <li className="flex items-start gap-2.5">
                    <MapPin size={14} className="text-[#B76E79] shrink-0 mt-0.5" />
                    <div>
                      <p className="text-[10px] text-stone-500 leading-none mb-1 font-sans">Gurgaon Studio Address</p>
                      <p className="text-[11px] text-stone-400 font-sans">Sector 54, Gurgaon, Haryana, 122003, India</p>
                    </div>
                  </li>
                </ul>
              </div>
            ...
            <div className="lg:col-span-3 space-y-4 font-sans">
              <h5 className="font-serif italic text-xs tracking-wide text-[#E8C8C8] pb-1 border-b border-white/5">
                Explore the Academy
              </h5>
              <ul className="space-y-3 text-xs text-stone-300">
                ...
                <li>
                  <button onClick={() => { setMode("public"); setTimeout(() => scrollToSection("mediakit"), 100); }} 
                          className="hover:text-[#B76E79] duration-200 cursor-pointer text-left block">
                    Brand Rates &amp; Media Kit
                  </button>
                </li>
                <li>
                  <button onClick={() => { setMode("public"); setTimeout(() => scrollToSection("contact"), 100); }} 
                          className="hover:text-[#B76E79] duration-200 cursor-pointer text-left block font-medium">
                    Reserve Placement Form
                  </button>
                </li>
                <li>
                  <button onClick={() => { setMode("admin"); }} 
                          className="hover:text-[#B76E79] duration-200 cursor-pointer text-left block font-medium text-amber-305">
            ...
            {/* COLUMN 3: Join Community Newsletter (beautiful warm aesthetic) */}
            <div className="lg:col-span-4 space-y-4 font-sans">
              <div className="bg-[#FAF8F5]/5 border border-[#B76E79]/15 rounded-3xl p-6 space-y-4 relative">
                <div className="absolute top-4 right-4 text-[#B76E79]/30">
                  <Sparkles size={16} />
                </div>
                
                <div className="space-y-1">
                  <h5 className="font-serif italic text-base text-[#E8C8C8]">
                    Join the Beauty Community
                  </h5>
                  <p className="text-[11.5px] text-stone-400 font-sans leading-relaxed">
                    Subscribe to receive premium beauty updates, client product swatches, and rare promotional discount credits.
                  </p>
                </div>
                ...
                <form
                  onSubmit={(e) => {
                    ...
                    if (emailInput && emailInput.value.trim() !== "") {
                      ...
                      emailInput.value = "";
                      alert("Successfully subscribed! Check your inbox for Rakhee's custom welcome booklet!");
                    }
                  }}
                  className="space-y-2.5 pt-1 text-xs font-sans"
                >
                  <input
                    type="email"
                    name="email"
                    ...
                    required
                    className="w-full bg-[#1A1817] text-xs px-4 py-3 rounded-xl text-white border border-white/10 focus:outline-none focus:border-[#B76E79] transition-all placeholder-stone-500 tracking-wide font-sans"
                  />
                  <button
                    type="submit"
                    className="w-full bg-[#B76E79] hover:bg-white hover:text-[#12100F] border border-[#B76E79] text-white py-3 px-4 rounded-xl cursor-pointer text-xs font-bold uppercase tracking-wider duration-300 flex items-center justify-center gap-2 font-sans"
                  >
                    <span>Subscribe to Registry</span>
                    <Send size={11} />
                  </button>
                </form>
                
                <p className="text-[10px] italic text-stone-500 text-center select-none pt-1 font-sans">
                  *Opt-out anytime. Fully secured billing and personal privacy guaranteed.
                </p>
              </div>
            </div>
          ...
          {/* BOTTOM BAR: Minimalist & Clean footer layout, no complex trust badges */}
          <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row items-center justify-between text-[11px] text-stone-500 gap-6 font-sans">
            
            <div className="flex flex-col md:flex-row items-center gap-4 text-center md:text-left">
              <span>&copy; {new Date().getFullYear()} Blush With Rakhee &bull; Verified Academy. All Rights Reserved.</span>
              
              <div className="flex items-center gap-1">
                {/* Admin Authenticate door */}
                <button
                  onClick={() => {
                  ...
                  className="opacity-20 hover:opacity-100 transition-opacity cursor-pointer p-1 text-white hover:text-[#B76E79]"
                  title="Secure Portal Log"
                >
                  <Lock size={12} />
                </button>
                <span className="text-stone-800">|</span>
                <span className="text-[10px] text-stone-600">Secure Direct Gateways</span>
              </div>
            </div>

            {/* Direct legal compliance links */}
            <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-2 text-[11px] text-stone-400 font-sans">
